        ...
        <div className="navbar bg-[#FFFFFF] shadow-sm px-2 md:px-12 py-3 md:py-5 sticky top-0 z-50">
            ...
            <div className="navbar-start">
                ...
                <NavLink to="/" className='flex gap-1 items-center '>
                    ...
                    <img className='w-7 h-7 md:w-11 md:h-11 ' src={logo} alt="" />

                    <h2 className=" text-[16px] md:text-2xl bg-gradient-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent font-bold ">AppVerse</h2>
